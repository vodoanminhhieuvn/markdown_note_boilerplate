...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserModel userInfo) loggedIn,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserModel userInfo)? loggedIn,
...
class _$_LoggedIn implements _LoggedIn {
  const _$_LoggedIn(this.userInfo);
  ...
  @override
  String toString() {
    return 'AuthState.loggedIn(userInfo: $userInfo)';
  }
...
abstract class _LoggedIn implements AuthState {
  const factory _LoggedIn(final UserModel userInfo) = _$_LoggedIn;
...
abstract class _Error implements AuthState {
  const factory _Error(final ApiException error) = _$_Error;
